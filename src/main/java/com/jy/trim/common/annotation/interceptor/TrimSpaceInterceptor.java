...
package com.jy.trim.common.annotation.interceptor;


import com.jy.trim.common.annotation.util.TrimUtils;
...
public class TrimSpaceInterceptor implements HandlerInterceptor {
     ...
     * @throws Throwable 异常
     */
    @Around(value = "@annotation(com.jy.trim.common.annotation.TrimSpace)")
