package com.jy.trim.common.trimspace.interceptor;

import com.jy.trim.common.trimspace.factory.TrimFactory;
import com.jy.trim.common.trimspace.factory.TrimSpaceFactory;
...
@Component @Aspect public class TrimSpaceInterceptor extends HandlerInterceptorAdapter {
     ...
     * @throws Throwable 异常
     */
    @Around(value = "@annotation(com.jy.trim.common.trimspace.annotation.TrimSpace)") public Object trimAround(
